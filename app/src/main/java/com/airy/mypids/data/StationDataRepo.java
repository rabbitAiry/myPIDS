...
import com.airy.mypids.object.LineLanguage;
...
//    public static int TRANSLATE_BY_NET = 3;
    private int translateMode = 0;
    private HashMap<String, String> englishDictionary;

    private static StationDataRepo repo;
    private StationDataRepo(){}
    public static StationDataRepo getInstance(){
        if(repo==null){
            repo = new StationDataRepo();
        }
        return repo;
    }

    // test only
    public Line getFakeLineItem(Context context){
        Line line = new Line("229"
                ...
                , LineLanguage.getDefaultChineseLineLanguage());
        return inflateEnglish(line, context);
    }

    public Line inflateEnglish(Line line, Context context){
        line.languageList.add(LineLanguage.getDefaultEnglishLineLanguage());
    ...
    public String getEnglish(String text, Context context){
    ...
    private String getPinyinWithBreak(String text) {
    ...
    private String getEnglishByDict(String text, Context context){
...
//        if(translateMode==0){
            // get and set
//        }
        return TRANSLATE_TO_PINYIN_WITH_BREAK;
    }

    public HashMap<String, String> getEnglishDictionary(Context context){
