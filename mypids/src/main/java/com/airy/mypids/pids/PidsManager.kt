...
//
//    fun getPidsFragment(styleName: String, context: Context, pidsInfo: PidsInfo): BasePidsFragment?{
//        return pidsNameMap[styleName]?.clazz?.getDeclaredConstructor(Context::class.java, PidsInfo::class.java)
//            ?.newInstance(context, pidsInfo)
//    }
//
